...
bg = pygame.image.load(r'C:\Users\Kamila\Pictures\Saved Pictures\mickey-clock.jpg')
BG_WIDTH = 500
BG_HEIGHT = 500
BG_X_POS = (SCREEN_WIDTH / 2 - BG_WIDTH / 2)
BG_Y_POS = (SCREEN_HEIGHT / 2 - BG_HEIGHT / 2)

big_arrow = pygame.image.load(r'C:\Users\Kamila\Pictures\Saved Pictures\big-arrow.png')
BIG_ARROW_WIDTH = 35
