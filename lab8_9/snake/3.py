...
class FRUIT:
    def __init__(self):
        self.randomize()
        self.image = pygame.image.load(r"C:\Users\Kamila\Pictures\Saved Pictures\apple.png")

    def draw_fruit(self):
        fruit_rect = self.image.get_rect(topleft=(int(self.pos.x * cell_size), int(self.pos.y * cell_size)))
